    ...
    items: [
      {
        ...
        a: 'Шкала со стрелкой на вкладке «Месяц». Показывает, сколько вы уже потратили относительно плана к текущему дню месяца. Если план 300 000 ₽ и прошла половина месяца, «по плану» — это ~150 000 ₽. Стрелка в зелёной зоне — укладываетесь, в красной — тратите быстрее плана.',
      },
      {
        icon: 'options',

    ...
    items: [
      {
        ...
        a: 'В Настройках можно включать и выключать блоки (баблометр, тепловая карта, скорость трат, вкладки «График»/«Цели» и т.д.). Оставьте только то, чем пользуетесь — остальное не будет загромождать экран. Настройка своя на каждом устройстве.',
      },
      {
        icon: 'moon',
        q: 'Тема оформления',

...
const STEPS: Step[] = [
  {
    icon: 'sparkles',
    title: 'Привет!',
    body: 'Я Финик — ваш семейный бухгалтер, буду рядом на всех экранах: порадуюсь доходам, поворчу за перерасход, отмечу цели. А это ваш семейный бюджет — общий учёт трат. Покажу за минуту, как им пользоваться.',
  },
  {

...
## 💰 Общая картина
Итого потрачено и % от планового бюджета. Темп трат бери ГОТОВЫМ из блока «=== ТЕМП ТРАТ ===» во входных данных (поля «Прошло дней», «Вердикт по темпу», «Прогноз») — не пересчитывай его сам и не выдумывай число прошедших дней.
...
- ТЕМП ТРАТ (важно, тут часто ошибаются): месяц считается ИДУЩИМ, пока во входных данных явно не написано «месяц завершён». Никогда не предполагай, что месяц «близится к завершению» — бери число прошедших дней строго из поля «Прошло дней: X из Y».

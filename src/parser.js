...
## 💰 Общая картина
Итого потрачено и % от планового бюджета. Темп трат опиши СВОИМИ СЛОВАМИ, взяв готовые цифры из блока «ТЕМП ТРАТ» во входных данных (сегодняшний день, средний расход в день, прогноз, вердикт). НЕ вставляй строки этого блока дословно и НЕ пиши служебные заголовки вроде «ТЕМП ТРАТ» или «===» в ответе.
...
- ТЕМП ТРАТ (важно, тут часто ошибаются): число прошедших дней бери ТОЛЬКО из строки «СЕГОДНЯ N-й календарный день месяца». НЕ определяй его по датам расходов, по последней трате или по графику выплат — «аванс к 10-му / зарплата к 25-му» это даты выплат, а НЕ количество прошедших дней. Средний расход в день и прогноз до конца месяца УЖЕ посчитаны в блоке — используй эти значения дословно, никогда не дели сам.
- Месяц считается ИДУЩИМ, пока во входных данных явно не написано «месяц завершён». Никогда не предполагай, что месяц «близится к завершению».
- Низкий % от МЕСЯЧНОГО бюджета в начале месяца — это НОРМА, а не «низкий темп»: к 4-му числу и должно быть потрачено ~13% бюджета, к 15-му ~50%. Оценивай темп ТОЛЬКО сравнивая «потрачено к этому дню» с «нормой к этому дню» из блока ТЕМП ТРАТ, а НЕ с полным месячным бюджетом.
- Если в данных вердикт «ОПЕРЕЖЕНИЕ ГРАФИКА» — прямо предупреди о риске перерасхода и приведи прогноз до конца месяца; НЕ называй это экономией, профицитом или низким темпом.
- Дневной расход = потрачено ÷ дней ПРОШЛО (уже посчитано в блоке ТЕМП ТРАТ), а не ÷ число дней в месяце.
